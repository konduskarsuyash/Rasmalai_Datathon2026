...
const FinancialNetworkPlayground = () => {
  ...
  // Keep selectedInstitution in sync with institutions array
  useEffect(() => {
    if (selectedInstitution) {
      const updated = institutions.find((i) => i.id === selectedInstitution.id);
      if (updated) {
  ...
  const handleUpdateInstitution = (id, updates) => {
    console.log('Updating institution:', id, updates);
  ...
  return (
    <div className="w-full h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 text-gray-900 overflow-hidden flex flex-col relative">
      ...
      <div className="flex-1 flex relative overflow-hidden">
        ...
        <div
          className={`${leftPanelOpen ? "w-80" : "w-0"} transition-all duration-300 bg-white/80 backdrop-blur-xl border-r border-gray-200 overflow-hidden relative z-50 shadow-lg`}
        >
        ...
        <div className="flex-1 relative z-10">
          ...
          <div className="absolute bottom-6 left-6 px-4 py-2 bg-white/90 backdrop-blur-xl border border-gray-300 rounded-xl text-sm text-gray-700 shadow-lg pointer-events-none">
          ...
          <div className="absolute bottom-20 left-6 w-72 max-h-64 overflow-y-auto space-y-2 scrollbar-hide pointer-events-none">
            {alerts
              .slice(-3)
              .reverse()
              .map((alert) => (
        ...
        <div
          className={`${rightPanelOpen ? "w-96" : "w-0"} transition-all duration-300 bg-white/80 backdrop-blur-xl border-l border-gray-200 overflow-hidden relative z-50 shadow-lg`}
        >
          <div className="h-full overflow-y-auto scrollbar-hide p-4 space-y-4">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-semibold flex items-center space-x-2">
